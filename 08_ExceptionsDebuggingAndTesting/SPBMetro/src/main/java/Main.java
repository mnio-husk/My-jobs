...
public class Main {
    ...
    private static Logger loggerFailStation;
    ...
    public static void main(String[] args) {
        loggerInfo = LogManager.getLogger("sInfo");
        loggerFailStation = LogManager.getLogger("sWrong");
        loggerErrors = LogManager.getLogger("exceptions");
        ...
        for (; ; ) {
            try {
                ...
                loggerInfo.info("Станция отправления: " + from + "  " + "Станция назначения: " + to);
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            loggerFailStation.warn("Станция не найдена: " + line);
